        ...
        <div id="content">
            ...
            <div class="inner">
                ...
                <hr />
                    ...
                    <form action="<?php echo base_url().'index.php/file_post/editpostproses/'.$idp ?>" class="form-horizontal"  method="post" role="form" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-12">
                            <?php
                            foreach($post as $row){
                                 $judul = $row->judul_post;
                                 $pesan = $row->post;
                                 $gambar = $row->gambar_post;
                             }
                            ...
                            <div class="group">
                                ...
                                <input class="form-control" name="judulpost" value="'.$judul.'"/>
                            </div>
                            <!------------------------------------------------------------------------------------------------------->
                            <br />
                            <div class="group">
                                    ...
                                    <div class="group">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px;">
                                                <img src="'.base_url().'asset/images/post/'.$gambar.''.'">
                                            </div>
                                            <div>
                                                <span class="btn btn-file btn-success">
                                                <span class="fileupload-new">Select image</span>
                                                <span class="fileupload-exists">Change</span>
                                                <input type="file" name="gambarpost"/></span>
                           ...
                           <!--s-------------------------------------------------------------------------------------------------------->
                            <div class="box">
                                ...
                                <div id="div-1" class="body collapse in">
                                    <textarea id="wysihtml5" class="form-control" rows="10" name="inpost">'.$pesan.'</textarea>    
                                </div>
                                <!--s--------------------------------------------------------------------------------------------------->
                            </div>
                            ';
