                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php foreach($gambarhalaman as $row){?>
                                        <tr class="odd gradeX">
                                            <td class="center"><?php echo $row->id_halaman;?></td>
                                            <td class="center"><?php echo $row->judul_halaman;?></td>
                                            <!--<td class="center"><?php echo $row->isi;?></td>-->
                                            <td class="center"><?php echo $row->gambar_halaman;?></td>
                                            <td class="center">
                                                <div class="col-lg-8">
                                                    <a href="<?php echo base_url().'index.php/file_halaman/edithalaman/'.$row->id_halaman; ?>" class="btn btn-danger btn-sm btn-grad">Edit</a>
                                                </div>
                                            </td>
                                            <!--<td class="center">
                                                <div class="col-lg-8">
                                                    <a href="<?php echo base_url().'index.php/file_halaman/halaman_delete/'.$row->id_halaman.'' ?>" class="btn btn-danger btn-sm btn-grad">Delete</a>
                                                </div>
                                            </td>-->
