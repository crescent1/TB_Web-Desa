    ...
    <!-- MENU SECTION --------------------------------------------------------------------------------------------------------------->
       <div id="left" >
        ...
        <div id="content">
            ...
            <div class="body">
                <form action="<?php echo base_url().'file_link/insert_link'?>" class="form-horizontal"  method="post" role="form" enctype="multipart/form-data">
                    <!--s------------------------------------------------------------------------------------------------------------->
                    <div class="form-group">
                        <label class="control-label col-lg-4">Masukkan Keterangan</label>
                        <div class="col-lg-8">
                            <input class="form-control" name="ketlink">
                        </div>
                    </div>
                    <!--s------------------------------------------------------------------------------------------------------------->
                    <div class="form-group">
                        <label class="control-label col-lg-4">Masukkan Link</label>
                        <div class="col-lg-8">
                            <textarea class="form-control" rows="3" name="enter"></textarea>
                        </div>
                    </div>
                    <!--s------------------------------------------------------------------------------------------------------------->
                    <div class="form-group">
