...
<!-- HEADER SECTION ------------------------------------------------------------------------------------------------------------->
    ...
    <div class="col-lg-12">
        <div class="box">
            ...
            <div class="body">
                <form action="<?php echo base_url().'index.php/file_upload/editsliderproses/'.$idS ?>" class="form-horizontal"  method="post" role="form" enctype="multipart/form-data">
                    <!--s------------------------------------------------------------------------------------------------------------->
                        ...
                        <div class="col-lg-8">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px;">
                                    <img src="'.base_url().'asset/images/slider/'.$gambar.''.'">
                                </div>
                                <div>
                    ...
                    <!--s------------------------------------------------------------------------------------------------------------->
                    <div class="form-group">
                        <label class="control-label col-lg-4">Masukkan Pesan</label>
                        <div class="col-lg-8">
                            <textarea class="form-control" rows="3" name="pesan" >'.$pesan1.'</textarea>
                        </div>
                    </div>
                    ';
                    ?>
