                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead   >
                                        <tr class="table-responsive">
                                            ...
                                            <th >Nama Ayah</th>
                                            <th >Edit</th>
                                            <th class="table-responsive">Del</th>
                                        </tr> 
                                    </thead>
                                    <tbody>
                                        <?php foreach($gambarbuku as $row){?>
                                        <tr class="odd gradeX">
                                            <td class="center"><?php echo $row->id_buku;?></td>
                                            <td class="center"><?php echo $row->nama;?></td>
                                            <td class="center"><?php echo $row->nik;?></td>
                                            <td class="center"><?php echo $row->tempat_lahir;?></td>
                                            <td class="center"><?php echo $row->tanggal_lahir;?></td>
                                            <td class="center"><?php echo $row->jenis_kelamin;?></td>
                                            <td class="center"><?php echo $row->shdk;?></td>
                                            <td class="center"><?php echo $row->agama;?></td>
                                            <td class="center"><?php echo $row->pendidikan_terakhir;?></td>
                                            <td class="center"><?php echo $row->pekerjaan;?></td>
                                            <td class="center"><?php echo $row->nama_ibu;?></td>
                                            <td class="center"><?php echo $row->nama_ayah;?></td>
                                            <td class="center">
                                                <div class="col-lg-8">
                                                    <a href="<?php echo base_url().'index.php/file_buku/editbuku/'.$row->id_buku; ?>" class="btn btn-danger btn-xs btn-grad">Edit</a>
                                                </div>
                                            </td>
                                            <td class="center">
                                                <div class="col-lg-8">
                                                    <a href="<?php echo base_url().'index.php/file_buku/buku_delete/'.$row->id_buku.'' ?>" class="btn btn-danger btn-xs btn-grad">Del</a>
                                                </div>
                                            </td>
