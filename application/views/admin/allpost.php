                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php foreach($gambarpost as $row){?>
                                        <tr class="odd gradeX">
                                            <td class="center"><?php echo $row->id_post;?></td>
                                            <td ><?php echo $row->judul_post;?></td>
                                            <!--<td ><?php echo $row->post;?></td>-->
                                            <td ><?php echo $row->tanggal_post;?></td>
                                            <td ><?php echo $row->gambar_post;?></td>
                                            <td >
                                                <div class="col-lg-8">
                                                    <a href="<?php echo base_url().'index.php/file_post/editpost/'.$row->id_post ?>" class="btn btn-danger btn-xs btn-grad">Edit</a>
                                                </div>
                                            </td>
                                            <td >
                                                <div class="col-lg-8">
                                                    <a href="<?php echo base_url().'index.php/file_post/post_delete/'.$row->id_post.'' ?>" class="btn btn-danger btn-xs btn-grad">Delete</a>
                                                </div>
                                            </td>
