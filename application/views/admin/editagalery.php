   ...
   <!-- MAIN WRAPPER -->
    ...
    <div class="col-lg-12">
        <div class="box">
            ...
            <div class="body">
                <form action="<?php echo base_url().'index.php/file_galery/editgaleryproses/'.$idg ?>" class="form-horizontal"  method="post" role="form" enctype="multipart/form-data">
                    <!--s------------------------------------------------------------------------------------------------------------->
                    <!--s------------------------------------------------------------------------------------------------------------->
                    <div class="row">
                        <div class="col-lg-12">
                    ...
                    foreach($galery as $row){
                                 $pesan = $row->keterangan_galery;
                                 $gambar = $row->gambar_galery;
                             }
                        ...
                        <div class="col-lg-8">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px;">
                                    <img src="'.base_url().'asset/images/galery/'.$gambar.''.'">
                                </div>
                                <div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <textarea class="form-control" rows="3" name="pesan1">'.$pesan.'</textarea>
                        </div>
                    </div>
                    ';
                    ?>
