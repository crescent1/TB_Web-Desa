        ...
        <div id="content">
            ...
            <div class="inner">
                ...
                <hr />
                    ...
                    <form action="<?php echo base_url().'index.php/file_halaman/edithalamanproses/'.$idh ?>" class="form-horizontal"  method="post" role="form" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-12">
                            <!-------------------------------------------------------------------------------------------------------->
                            <?php
                            foreach($halaman as $row){
                                 $judul = $row->judul_halaman;
                                 $pesan = $row->isi;
                                 $gambar = $row->gambar_halaman;
                             }
                            
                            echo '
                            <div class="group">
                                    <label> Masukkan Judul</label>
                                    <input class="form-control" name="judulhalaman" value="'.$judul.'">
                            </div>
                            <!------------------------------------------------------------------------------------------------------->
                            <br />
                            <div class="group">
                                    ...
                                    <div class="group">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px;">
                                                <img src="'.base_url().'asset/images/halaman/'.$gambar.''.'">
                                            </div>
                                            <div>
                           ...
                           <!--s-------------------------------------------------------------------------------------------------------->
                            <div class="box">
                                ...
                                <div id="div-1" class="body collapse in">
                                    <textarea id="wysihtml5" class="form-control" rows="10" name="inhalaman">'.$pesan.'</textarea>    
                                </div>
                                <!--s--------------------------------------------------------------------------------------------------->
                            </div>
                            ';
