                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php foreach($linkpost as $row){?>
                                        <tr class="odd gradeX">
                                            <td class="center"><?php echo $row->id_download;?></td>
                                            <td class="center"><?php echo $row->keterangan;?></td>
                                            <td class="center"><?php echo $row->download ;?></td>
                                            <td class="center">
                                                <div class="col-lg-8">
                                                    <a href="<?php echo base_url().'index.php/file_link/link_delete/'.$row->id_download.'' ?>" class="btn btn-danger btn-xs btn-grad">Delete</a>
                                                </div>
                                            </td>
