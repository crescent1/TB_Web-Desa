                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="collapseOne" class="accordion-body collapse in body">
                                    <form action="<?php echo base_url().'index.php/file_buku/insert_buku'?>" class="form-horizontal" id="block-validate" method="post" role="form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="required2" name="nik" class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="required2" name="tempat_lahir" class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="date" id="date2" name="tanggal_lahir" class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="required2" name="shdk" class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="required2" name="pekerjaan"  class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="required2" name="nama_ibu"  class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="required2" name="nama_ayah" class="form-control" />
                                            </div>
                                        </div>
