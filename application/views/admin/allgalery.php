                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php foreach($gambargalery as $row): ?>
                                        <tr class="odd gradeX">
                                            <td class="center"><?php echo $row->id_galery;?></td>
                                            <td class="center"><?php echo $row->keterangan_galery;?></td>
                                            <td class="center"><img src="<?php echo base_url().'asset/images/galery/' .$row->gambar_galery;?>" style="width:300px"></td>
                                            <td class="center">
                                                <div class="col-lg-8">
                                                    <a href="<?php echo base_url().'index.php/file_galery/editagalery/'.$row->id_galery; ?>" class="btn btn-danger btn-sm btn-grad">Edit</a>
                                                </div>
                                            </td>
                                            <td class="center">
                                                <div class="col-lg-8">
                                                    <a href="<?php echo base_url().'index.php/file_galery/galery_delete/'.$row->id_galery.'' ?>" class="btn btn-danger btn-sm btn-grad">Delete</a>
                                                </div>
                                            </td>
